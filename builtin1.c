...
/**
 * _myhistory - this  code displays the history list, one command by line, preceded
...
/**
 * set_alias - this code sets alias to a string
...
/**
 * print_alias -  it prints an alias string in the code
 * @node: alias node code
 *
...
/**
 * _myalias - this code mimics the alias builtin (man alias)
