...
/**
 * add_node - this functionadds a node to the start of the list
 * @head: address of pointer to head node
 * @str: str field of node
 * @num: this node index used by history
 *
 * Return: size of list
 */
...
/**
 * print_list_str - this function prints only the string element of a list_t linked list
